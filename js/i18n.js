...
(function () {
  ...
  const dict = {
    ko: {
      ...
      cleanFormulaHintAccess: "객체로 각 행 접근. 예:",
      cleanFormulaHintBracket: "한글·공백·특수문자 컬럼은 대괄호로:",
    ...
    en: {
      ...
      cleanFormulaHintAccess: "accesses each row. e.g.",
      cleanFormulaHintBracket: "For Korean / spaced / special columns use brackets:",
