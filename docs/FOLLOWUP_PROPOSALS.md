...
| P10 | Planned 잔여 (~~DT/NB/CV~~·~~SQL JOIN~~·~~공유링크~~·PPT 매핑) | 기능 | 대 | ★★ | 부분 — **DT/NB/CV ✅**(§0-0e), **SQL JOIN ✅DuckDB**(§0-0d), **공유링크 ✅**(`feat/p10-share-link` — #p= fragment·deflate·A1보안전제, Node 315·E2E 25). **PPT 매핑만 잔여** |
