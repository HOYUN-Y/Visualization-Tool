...
![Tests](https://img.shields.io/badge/tests-361%20unit%20%2B%2073%20E2E-success)
...
> 상세·근거·해소 이력: [`IMPLEMENTATION_PLAN.md` §12](./IMPLEMENTATION_PLAN.md)
>
> **2026-07-18 실사 백로그 소탕 완료** — 정확성(E1~E6)·구조(F1~F6)·전역 리렌더(C1)·formula 한글(B3′), 그리고 배포 선행이던 A2·A4·A6·C3까지 전부 해소. **남은 건 아래 조건부 대기 항목뿐.**
